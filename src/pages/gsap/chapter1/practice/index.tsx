...
export default function PracticePage() {
  ...
  const emartPathRef = useRef<SVGPathElement>(null);
  const emartPickRef = useRef(null);
  const mediPathRef = useRef(null);
  const mediPickRef = useRef(null);
  ...
  const handleMart = () => {
    ...
    tl.set(emartPickRef.current, {
      opacity: 0,
    })
      .to(MapRef.current, { scale: 1, x: 0, y: 0 })
      .to(emartPathRef.current, {
        strokeDashoffset: 0,
      });
    //   .to(HereRef.current, {
    //     motionPath: {
    //       path: emartPathRef.current,
    //       align: emartPathRef.current,
    //     },
    //   });
  };
    ...
    <div style={{ backgroundColor: "#333", width: "100%", height: "100vh" }}>
      <Wrapper className="container">
        <nav className="navigation">
          <ul>
            <li className="current" onClick={handleHere}>
              <div>
                <svg
                  width="53"
                  height="53"
            ...
            <li className="medi" onClick={handleHospital}>
              <div>
                <svg
                  width="53"
                  height="53"
          ...
          <svg
            ...
            <g id="route">
              ...
              <g id="emart">
                ...
                />
                <g className="pick" ref={emartPickRef}>
                  <circle
                    id="Ellipse 1"
                    cx="903.842"
                    cy="423.714"
              ...
              <g id="medi">
                <path
                  ...
                  strokeLinejoin="round"
                />
                <g className="pick" ref={mediPickRef}>
                  <circle
                    id="Ellipse 1_2"
                    cx="78.8416"
                    cy="388.714"
